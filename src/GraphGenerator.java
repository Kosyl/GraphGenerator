...
public class GraphGenerator<V, E> {
	...
	public static void main(String[] args) {
		...
		int numVertices = 50;	//ErdosRenyiGenerator option
		int iterations = 10;
		
		//ErdosRenyiGenerator options
		double probability = 0.1;
		int numEdges = (int) (numVertices*(numVertices-1)/2*probability);
		...
		EdgeFactory edgeFactory = new EdgeFactory(1.0, 100.0);
